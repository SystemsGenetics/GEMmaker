...
ENV PATH /opt/conda/envs/systemsgenetics-gemmaker-2.0.0/bin:$PATH

# Dump the details of the installed packages to a file for posterity
RUN conda env export --name systemsgenetics-gemmaker-2.0.0 > systemsgenetics-gemmaker-2.0.0.yml
