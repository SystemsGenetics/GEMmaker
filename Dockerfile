...
ENV PATH /opt/conda/envs/systemsgenetics-gemmaker-2.1.0dev/bin:$PATH

# Dump the details of the installed packages to a file for posterity
RUN conda env export --name systemsgenetics-gemmaker-2.1.0dev > systemsgenetics-gemmaker-2.1.0dev.yml
